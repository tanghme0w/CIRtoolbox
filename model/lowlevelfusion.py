...
class LowLevelFusion(DualEncoderModel):
...
def encoder_forward_llf(
    ...
    for idx, encoder_layer in enumerate(self.layers):
        ...
        if idx + 1 in stack_layers:                     #
            stack_hidden_states += [layer_outputs[0]]   #
    ...
    hidden_states = sum(stack_hidden_states) / len(stack_hidden_states)     #
